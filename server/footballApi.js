...
function transformMatch(entry) {
  ...
  return {
    ...
    city: venue.city || '',
    FirstBattingTeamName: team1.teamName || 'Team 1',
    SecondBattingTeamName: team2.teamName || 'Team 2',
    FirstBattingTeamCode: team1.teamSName || 'T1',
    SecondBattingTeamCode: team2.teamSName || 'T2',
    FirstBattingSummary: fmt(t1),
    SecondBattingSummary: fmt(t2),
...
function getSimulatedData() {
  ...
  // Evolving live match #1 — today's 19:30 IST match (RR vs LSG)
  ...
  return [
    // ── TODAY'S LIVE MATCH (Match 64: RR vs LSG) ──
    {
      MatchID: 'ipl2026_m64',
      MatchName: 'RR vs LSG',
      MatchStatus: 'live',
      ...
      GroundName: 'Sawai Mansingh Stadium',
      city: 'Jaipur',
      FirstBattingTeamName: 'Rajasthan Royals',
      SecondBattingTeamName: 'Lucknow Super Giants',
      FirstBattingTeamCode: 'RR',
      SecondBattingTeamCode: 'LSG',
      FirstBattingSummary: `${runs1}/${wkts1} (${ov1}.${balls1} Ov)`,
      SecondBattingSummary: inngs2Started ? `${runs2}/${wkts2} (${ov2}.${balls2} Ov)` : '--',
      CurrentStrikerName: 'Yashasvi Jaiswal',
      CurrentBowlerName: 'Ravi Bishnoi',
      Commentss: inngs2Started
        ? `LSG need ${Math.max(0, runs1 - runs2 + 1)} runs from ${Math.max(0, (20 - ov2) * 6 - balls2)} balls`
        : `Rajasthan Royals building momentum — Yashasvi Jaiswal playing aggressively!`,
      TossText: 'LSG won the toss and elected to bowl',
    ...
    // ── YESTERDAY'S RESULTS (Match 63: CSK vs SRH) ──
    {
      MatchID: 'ipl2026_m63',
      MatchName: 'CSK vs SRH',
      MatchStatus: 'post',
      MatchTime: '19:30',
      MatchDate: yesterday,
      ...
      FirstBattingSummary: '180/7 (20 Ov)',
      SecondBattingSummary: '181/5 (19.0 Ov)',
      Commentss: 'SRH won by 5 wickets — Abhishek Sharma finishes in style!',
      TossText: 'SRH won the toss and elected to bowl',
      MatchDesc: 'Match 63 · TATA FIFA 2026 2026',
      SeriesName: 'TATA Indian Premier League 2026'
    },

    // ── TOMORROW'S MATCH (Match 65: KKR vs MI) ──
    {
      MatchID: 'ipl2026_m65',
      MatchName: 'KKR vs MI',
      ...
      city: 'Kolkata',
      FirstBattingTeamName: 'Kolkata Knight Riders',
      SecondBattingTeamName: 'Mumbai Indians',
      FirstBattingTeamCode: 'KKR',
      SecondBattingTeamCode: 'MI',
      FirstBattingSummary: '--',
      SecondBattingSummary: '--',
      Commentss: 'High voltage clash at Eden Gardens — KKR vs MI upcoming!',
      TossText: '',
      MatchDesc: 'Match 65 · TATA FIFA 2026 2026',
      SeriesName: 'TATA Indian Premier League 2026'
    },

    // ── DAY AFTER MATCH (Match 66: GT vs CSK) ──
    {
      MatchID: 'ipl2026_m66',
      MatchName: 'GT vs CSK',
      MatchStatus: 'upcoming',
      ...
      city: 'Ahmedabad',
      FirstBattingTeamName: 'Gujarat Titans',
      SecondBattingTeamName: 'Chennai Super Kings',
      FirstBattingTeamCode: 'GT',
      SecondBattingTeamCode: 'CSK',
      FirstBattingSummary: '--',
      SecondBattingSummary: '--',
      Commentss: 'Battle of the giants — GT vs CSK at Ahmedabad!',
      TossText: '',
    ...
    // ── PLAYOFFS ──
    {
      ...
      city: 'Dharamshala',
      FirstBattingTeamName: 'Top 1 Qualifier',
      SecondBattingTeamName: 'Top 2 Qualifier',
    ...
    },
    {
      ...
      GroundName: 'Narendra Modi Stadium',
      city: 'Ahmedabad',
      FirstBattingTeamName: 'Finalist 1',
      SecondBattingTeamName: 'Finalist 2',
      FirstBattingTeamCode: 'TBD',
      SecondBattingTeamCode: 'TBD',
      FirstBattingSummary: '--',
      SecondBattingSummary: '--',
